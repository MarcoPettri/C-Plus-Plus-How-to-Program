...
Package::Package(const std::string& from_nme, const std::string& to_nme,
...
void Package::set_weight(double rhs)
{
	if (rhs < 0.0f) {
...
void Package::set_cost(double rhs) 
{
	if (rhs < 0.0f) {
...
std::string& Package::get_from_nme()
{
	return inf.begin()->from;
}

std::string& Package::get_to_nme()
{
	return inf.begin()->to;
}

std::string& Package::get_from_addr()
{
	return this->advance(1, true);
}

std::string& Package::get_to_addr()
{
	
	return this->advance(1, false);
}

std::string& Package::get_from_cty()
{

	return this->advance(2, true);
}

std::string& Package::get_to_cty()
{

	return this->advance(2, false);
}

std::string& Package::get_from_stat()
{
	return this->advance(3, true);
}

std::string& Package::get_to_stat()
{
	return this->advance(3, false);
}

std::string& Package::get_from_zip()
{
	return this->advance(4, true);
}

std::string& Package::get_to_zip()
{
...
*/
std::string& Package::advance(int step, bool key)
{
	auto it{ inf.begin() };
